...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="food_scores",
                        to="services.foodrecommendation",
                    ),
                ),
            ],
            options={
                "indexes": [
                    models.Index(
                        fields=["food_recommendation"],
                        name="services_fo_food_re_0d3bd6_idx",
                    ),
                    models.Index(
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["user"], name="services_fo_user_id_610ec4_idx"),
        ),
        migrations.AddIndex(
