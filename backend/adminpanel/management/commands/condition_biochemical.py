...
#             try:
#                 # Retrieve the Biochemical object
#                 biochemical = Biochemical.objects.get(name=biochemical_name)
#                 created = False
#             except ObjectDoesNotExist:
#                 # Skip this biochemical if it does not exist
#                 self.stdout.write(self.style.ERROR(f'Biochemical not found: {biochemical_name}'))
#                 continue
            
#             # Retrieve Condition objects from cache
#             hypo_conditions = [condition_cache.get(condition_name) for condition_name in conditions.get("hypo_conditions", [])]
#             hyper_conditions = [condition_cache.get(condition_name) for condition_name in conditions.get("hyper_conditions", [])]
            
#             # Remove None values if conditions were not found in cache
#             hypo_conditions = list(filter(None, hypo_conditions))
#             hyper_conditions = list(filter(None, hyper_conditions))
            
#             # Set conditions for the Biochemical object
#             biochemical.hypo_conditions.set(hypo_conditions)
#             biochemical.hyper_conditions.set(hyper_conditions)
            
#             # Save changes to the Biochemical object
#             biochemical.save()
